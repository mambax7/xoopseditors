...
function xinha_pass_to_php_backend($Data, $KeyLocation = 'Xinha:BackendKey', $ReturnPHP = false)
{
    ...
    $bk['hash']         = function_exists('sha1') ? sha1($_SESSION[$KeyLocation] . $bk['data']) : md5($_SESSION[$KeyLocation] . $bk['data']);
    ...
    if ($ReturnPHP) {
        return ['backend_data' => $backend_data];
    } else {
