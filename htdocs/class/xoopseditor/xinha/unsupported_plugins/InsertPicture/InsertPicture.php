...
$limitedext  = ['.gif', '.jpg', '.png', '.jpeg']; //Extensions you want files uploaded limited to.
...
if (isset($_FILES['file'])) {
    ...
    } elseif (file_exists($LocalPicturePath . $file['name'])) {
        $message = 'The file you are uploading already exists.';
    } elseif ($file['size'] > $limitedsize) {
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Init() {
            ...
            <?php If ('' <> $DestFileName) echo 'CopyToURL("' . $PicturePath . $DestFileName . '");'
            ?>
        }
    ...
    <tr>
        <td>Images on the Server:<?php /*echo $LocalPicturePath*/ ?><br>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <button type="submit" name="ok" onclick="onUpload();">Upload file</button>
                <br>
