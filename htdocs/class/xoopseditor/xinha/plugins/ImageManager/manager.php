                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <?php
                            if (false == $IMConfig['safe_mode'] && $IMConfig['allow_new_dir']) {
                                ?>
            ...
            <div id="youtubeChooser" style="display:none" class="chooserPanel">
                ...
                <table width="100%">
                    <tr>
                        <th>
                            <labelfor
                            ="ytUsername">YouTube Username</label></th>
                        <td>
            ...
            <div id="flickrChooser" style="display:none" class="chooserPanel">
                ...
                <table width="100%">
                    <tr>
                        <th>
                            <labelfor
                            ="ytUsername">Flickr Username/Email</label></th>
                        <td>
        ...
        <tr>
            ...
            <td rowspan="2">
                <div style="position:relative">
                    <img src="<?php print $IMConfig['base_url']; ?>img/locked.gif" id="imgLock" width="25" height="32" alt="Constrained Proportions" style="vertical-align: middle;"/><input type="checkbox" id="constrain_prop" checked="checked" onclick="javascript:toggleConstrains(this);"
                                                                                                                                                                                             style="position:absolute;top:8px;left:0px;" value="on"/>
                </div>
            </td>
