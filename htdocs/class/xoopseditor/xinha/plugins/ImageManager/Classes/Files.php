...
class Files
{
     ...
     * @param bool   $unique            create unique destination file if true.
     ...
     * @return bool true if the new folder is created, false otherwise.
     */
     ...
     * @param bool   $recursive  if true, all files and sub-directories
    ...
    public function renameFile($oldPath, $newName)
    {
        ...
        $newPath = $oldFileParts['dirname'] . '/' . $newName . (!empty($oldFileParts['extension']) ? '.' . $oldFileParts['extension'] : '');
     ...
     */
    public function copyDir($basePath, $source, $dest, $overwrite = false)
    {
