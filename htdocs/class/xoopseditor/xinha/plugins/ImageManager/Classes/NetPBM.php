...
Class Image_Transform_Driver_NetPBM extends Image_Transform
{
    ...
    {
        $this->command[] = IMAGE_TRANSFORM_LIB_PATH . "pnmcut -left $crop_x -top $crop_y -width $crop_width -height $crop_height";
    }
    ...
    public function addText($params)
    {
        ...
        $this->command[] = "ppmlabel -angle $angle -colour $color -size " . "$size -x $x -y " . $y + $size . " -text \"$text\"";
    } // End addText
    ...
    public function _postProcess($type, $quality, $save_type)
    {
        ...
        array_unshift(
            $this->command,
            IMAGE_TRANSFORM_LIB_PATH . $type . 'topnm ' . $this->image
        );
        $arg = '';
