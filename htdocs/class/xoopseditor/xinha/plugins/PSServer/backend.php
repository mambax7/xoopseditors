...
if (get_magic_quotes_gpc()) {
    $to_clean = [&$_GET, &$_POST, &$_REQUEST, &$_COOKIE];
 ...
 */
$HTTP_ERRORS = [
    'HTTP_SUCCESS_OK'                => ['code' => 200, 'message' => 'OK'],
    'HTTP_SUCCESS_CREATED'           => ['code' => 201, 'message' => 'Created'],
    'HTTP_SUCCESS_ACCEPTED'          => ['code' => 202, 'message' => 'Accepted'],
    'HTTP_SUCCESS_NON_AUTHORITATIVE' => ['code' => 203, 'message' => 'Non-Authoritative Information'],
    'HTTP_SUCCESS_NO_CONTENT'        => ['code' => 204, 'message' => 'No Content'],
    'HTTP_SUCCESS_RESET_CONTENT'     => ['code' => 205, 'message' => 'Reset Content'],
    'HTTP_SUCCESS_PARTIAL_CONTENT'   => ['code' => 206, 'message' => 'Partial Content'],

    'HTTP_REDIRECTION_MULTIPLE_CHOICES' => ['code' => 300, 'message' => 'Multiple Choices'],
    'HTTP_REDIRECTION_PERMANENT'        => ['code' => 301, 'message' => 'Moved Permanently'],
    'HTTP_REDIRECTION_FOUND'            => ['code' => 302, 'message' => 'Found'],
    'HTTP_REDIRECTION_SEE_OTHER'        => ['code' => 303, 'message' => 'See Other'],
    'HTTP_REDIRECTION_NOT_MODIFIED'     => ['code' => 304, 'message' => 'Not Modified'],
    'HTTP_REDIRECTION_USE_PROXY'        => ['code' => 305, 'message' => 'Use Proxy'],
    'HTTP_REDIRECTION_UNUSED'           => ['code' => 306, 'message' => '(Unused)'],
    'HTTP_REDIRECTION_TEMPORARY'        => ['code' => 307, 'message' => 'Temporary Redirect'],

    'HTTP_CLIENT_BAD_REQUEST'                  => ['code' => 400, 'message' => 'Bad Request'],
    'HTTP_CLIENT_UNAUTHORIZED'                 => ['code' => 401, 'message' => 'Unauthorized'],
    'HTTP_CLIENT_PAYMENT_REQUIRED'             => ['code' => 402, 'message' => 'Payment Required'],
    'HTTP_CLIENT_FORBIDDEN'                    => ['code' => 403, 'message' => 'Forbidden'],
    'HTTP_CLIENT_NOT_FOUND'                    => ['code' => 404, 'message' => 'Not Found'],
    'HTTP_CLIENT_METHOD_NOT_ALLOWED'           => ['code' => 405, 'message' => 'Method Not Allowed'],
    'HTTP_CLIENT_NOT_ACCEPTABLE'               => ['code' => 406, 'message' => 'Not Acceptable'],
    'HTTP_CLIENT_PROXY_AUTH_REQUIRED'          => ['code' => 407, 'message' => 'Proxy Authentication Required'],
    'HTTP_CLIENT_REQUEST_TIMEOUT'              => ['code' => 408, 'message' => 'Request Timeout'],
    'HTTP_CLIENT_CONFLICT'                     => ['code' => 409, 'message' => 'Conflict'],
    'HTTP_CLIENT_GONE'                         => ['code' => 410, 'message' => 'Gone'],
    'HTTP_CLIENT_LENGTH_REQUIRED'              => ['code' => 411, 'message' => 'Length Required'],
    'HTTP_CLIENT_PRECONDITION_FAILED'          => ['code' => 412, 'message' => 'Precondition Failed'],
    'HTTP_CLIENT_REQUEST_TOO_LARGE'            => ['code' => 413, 'message' => 'Request Entity Too Large'],
    'HTTP_CLIENT_REQUEST_URI_TOO_LARGE'        => ['code' => 414, 'message' => 'Request-URI Too Long'],
    'HTTP_CLIENT_UNSUPPORTED_MEDIA_TYPE'       => ['code' => 415, 'message' => 'Unsupported Media Type'],
    'HTTP_CLIENT_REQUESTED_RANGE_NOT_POSSIBLE' => ['code' => 416, 'message' => 'Requested Range Not Satisfiable'],
    'HTTP_CLIENT_EXPECTATION_FAILED'           => ['code' => 417, 'message' => 'Expectation Failed'],

    'HTTP_SERVER_INTERNAL'            => ['code' => 500, 'message' => 'Internal Server Error'],
    'HTTP_SERVER_NOT_IMPLEMENTED'     => ['code' => 501, 'message' => 'Not Implemented'],
    'HTTP_SERVER_BAD_GATEWAY'         => ['code' => 502, 'message' => 'Bad Gateway'],
    'HTTP_SERVER_SERVICE_UNAVAILABLE' => ['code' => 503, 'message' => 'Service Unavailable'],
    'HTTP_SERVER_GATEWAY_TIMEOUT'     => ['code' => 504, 'message' => 'Gateway Timeout'],
    'HTTP_SERVER_UNSUPPORTED_VERSION' => ['code' => 505, 'message' => 'HTTP Version not supported']
];
 ...
 * @return bool Whether or not the HTTP method is correct for the given input.
 */
 ...
 * @return bool Whether or not the input received is valid.
 */
 ...
 * @param int    $code    The HTTP error code to return to the client.  This defaults to 400.
 ...
 * @param int    $depth     The private argument used to limit recursion depth.
        ...
        while (false !== ($file = readdir($dir))) {
            ...
            if ('dir' == filetype($filepath)) {
                ...
                if ($imageinfo) {
                    ...
                    if (('.htm' == $extension) || ('.html' == $extension)) {
                        $result[$file] = ['$type' => 'html'];
                    } else {
                        $result[$file] = ['$type' => 'text'];
                    }
                } else {
                    $result[$file] = ['$type' => 'document'];
                }
            }
        }
...
function file_copy($filename, $chroot)
{
    ...
    for ($count = 1; $count < MAX_FILES_PER_FOLDER; ++$count) {
        ...
        if ($file = @fopen($copyname, 'x')) {
            ...
            return [basename($copyname) => ['$type' => 'image']];
        }
    }
