...
class getid3_optimfrog extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ('*RIFF' == substr($ofr_header, 0, 5)) {
            return $this->ParseOptimFROGheader42($getid3->fp, $getid3->info);
        } elseif ('OFR' == substr($ofr_header, 0, 3)) {
            ...
            switch ($block_name) {
                case 'OFR ':
                    ...
                    if ($block_size > 12) {
                        ...
                        if (7 == (($info_ofr_this_block['raw']['encoder_id'] & 0xF0) >> 4)) { // v4.507
                ...
                case 'COMP':
                    ...
                    if (0x454E4F4E == $comp_data['crc_32']) {
