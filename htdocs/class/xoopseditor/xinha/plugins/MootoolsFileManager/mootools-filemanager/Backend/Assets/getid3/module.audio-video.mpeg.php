...
class getid3_mpeg extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if (0x3FFFF == $info_mpeg_video_raw['bitrate']) { // 18 set bits
    ...
    public static function MPEGsystemNonOverheadPercentage($video_bitrate, $audio_bitrate)
    {
        ...
        static $overhead_multiplier_by_bitrate = [
            32  => [0, 0.9676287944368530, 0.9802276264360310, 0.9844916183244460, 0.9852821845179940],
            48  => [0, 0.9779100089209830, 0.9787770035359320, 0.9846738664076130, 0.9852683013799960],
            56  => [0, 0.9731249855367600, 0.9776624308938040, 0.9832606361852130, 0.9843922606633340],
            64  => [0, 0.9755642683275760, 0.9795256705493390, 0.9836573009193170, 0.9851122539404470],
            96  => [0, 0.9788025247497290, 0.9798553314148700, 0.9822956869792560, 0.9834815119124690],
            128 => [0, 0.9816940050925480, 0.9821675936072120, 0.9829756927470870, 0.9839763420152050],
            160 => [0, 0.9825894094561180, 0.9820913399073960, 0.9823907143253970, 0.9832821783651570],
            192 => [0, 0.9832038474336260, 0.9825731694317960, 0.9821028622712400, 0.9828262076447620],
            224 => [0, 0.9836516298538770, 0.9824718601823890, 0.9818302180625380, 0.9823735101626480],
            256 => [0, 0.9845863022094920, 0.9837229411967540, 0.9824521662210830, 0.9828645172100790],
            320 => [0, 0.9849565280263180, 0.9837683142805110, 0.9822885275960400, 0.9824424382727190],
            384 => [0, 0.9856094774357600, 0.9844573394432720, 0.9825970399837330, 0.9824673808303890]
        ];
