...
class getid3_apetag extends getid3_handler
{
    ...
    */
    ...
    public function Analyze()
    {
        ...
        if (0 == $this->option_override_end_offset) {
            ...
            if ('APETAGEX' == substr($apetag_footer_id3v1, strlen($apetag_footer_id3v1) - 160, 8)) {            // 160 = ID3v1_TAG_SIZE + APETAG_HEADER_SIZE
                $getid3->info['ape']['tag_offset_end'] = filesize($getid3->filename) - 128;                     // 128 = ID3v1_TAG_SIZE
            } // APE tag found, no ID3v1
            elseif ('APETAGEX' == substr($apetag_footer_id3v1, strlen($apetag_footer_id3v1) - 32, 8)) {         // 32 = APETAG_HEADER_SIZE
        ...
        for ($i = 0; $i < $info_ape['footer']['raw']['tag_items']; $i++) {
            ...
            if (false === strstr(substr($apetag_data, $offset), "\x00")) {
            ...
            switch (strtolower($item_key)) {
                ...
                case 'mp3gain_undo':
                    ...
                    $info_replaygain['mp3gain']['undo_wrap']  = (('Y' == $mp3gain_undo_wrap) ? true : false);
                    break;
