...
class getid3_iconv_replacement
{
    ...
    public static function iconv($in_charset, $out_charset, $string)
    {
        ...
        if (is_callable(['getid3_iconv_replacement', $function_name])) {
