...
class getid3_shorten extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $getid3->info['shn']['seektable']['present'] = (bool)('SHNAMPSK' == substr($seek_table_signature_test, 4, 8));
        ...
        if (@$output && 'fmt ' == substr($output, 12, 4)) {
            ...
            if ('data' == substr($output, 20 + $fmt_size, 4)) {
