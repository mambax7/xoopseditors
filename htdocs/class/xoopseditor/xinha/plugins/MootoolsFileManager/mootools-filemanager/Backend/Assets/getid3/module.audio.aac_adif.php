...
class getid3_aac_adif extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        $info_aac_header['copyright'] = '1' == $aac_header_bitstream{$bit_offset++};
        ...
        $info_aac_header['original_copy'] = '1' == $aac_header_bitstream{$bit_offset++};
        $info_aac_header['home']          = '1' == $aac_header_bitstream{$bit_offset++};
        $info_aac_header['is_vbr']        = '1' == $aac_header_bitstream{$bit_offset++};
        ...
        for ($i = 0; $i < $info_aac_header['num_program_configs']; $i++) {
            ...
            $info_aac_program_configs_i['mono_mixdown_present'] = 1 == $aac_header_bitstream{$bit_offset++};
            ...
            $info_aac_program_configs_i['stereo_mixdown_present'] = 1 == $aac_header_bitstream{$bit_offset++};
            ...
            $info_aac_program_configs_i['matrix_mixdown_idx_present'] = 1 == $aac_header_bitstream{$bit_offset++};
            if ($info_aac_program_configs_i['matrix_mixdown_idx_present']) {
                ...
                $bit_offset                                           += 2;
                $info_aac_program_configs_i['pseudo_surround_enable'] = 1 == $aac_header_bitstream{$bit_offset++};
            }

            for ($j = 0; $j < $info_aac_program_configs_i['num_front_channel_elements']; $j++) {
                $info_aac_program_configs_i['front_element_is_cpe'][$j]     = 1 == $aac_header_bitstream{$bit_offset++};
            ...
            for ($j = 0; $j < $info_aac_program_configs_i['num_side_channel_elements']; $j++) {
                $info_aac_program_configs_i['side_element_is_cpe'][$j]     = 1 == $aac_header_bitstream{$bit_offset++};
            ...
            for ($j = 0; $j < $info_aac_program_configs_i['num_back_channel_elements']; $j++) {
                $info_aac_program_configs_i['back_element_is_cpe'][$j]     = 1 == $aac_header_bitstream{$bit_offset++};
            ...
            for ($j = 0; $j < $info_aac_program_configs_i['num_valid_cc_elements']; $j++) {
                $info_aac_program_configs_i['cc_element_is_ind_sw'][$j]        = 1 == $aac_header_bitstream{$bit_offset++};
    ...
    public static function AACchannelCountCalculate($program_configs)
    {
        ...
        foreach (['front', 'side', 'back'] as $placement) {
