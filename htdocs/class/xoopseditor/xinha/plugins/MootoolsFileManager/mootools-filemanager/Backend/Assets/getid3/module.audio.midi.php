...
class getid3_midi extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        foreach ($track_data_array as $track_number => $track_data) {
            ...
            while ($events_offset < strlen($track_data)) {
                ...
                switch ($midi_events[$track_number][$event_id]['eventid']) {
                    ...
                    case 0xC:       // Program (patch) change
                        ...
                        $info_midi_raw['track'][$track_number]['instrument']   = 10 == $track_number ? getid3_midi::GeneralMIDIpercussionLookup($new_program_num) : getid3_midi::GeneralMIDIinstrumentLookup($new_program_num);
                        break;
                    ...
                    case 0xF:
                        ...
                        if (0xF == $midi_events[$track_number][$event_id]['channel']) {
            ...
            if (($track_number > 0) || (1 == count($track_data_array))) {
