...
class getid3_id3v1 extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ('TAG' == substr($id3v1_tag, 0, 3)) {
            ...
            if (("\x00" === $id3v1_tag{125}) && ("\x00" !== $id3v1_tag{126})) {
            ...
            if (empty($info_id3v1['genre']) || ('Unknown' == @$info_id3v1['genre'])) {
                unset($info_id3v1['genre']);
            }

            foreach ($info_id3v1 as $key => $value) {
                'comments' != $key and $info_id3v1['comments'][$key][0] = $value;
            }
        ...
        if ('TAG' == substr($pre_id3v1, 0, 3)) {
            ...
            if ('APETAGEX' == substr($pre_id3v1, 96, 8)) {
                // an APE tag footer was found before the last ID3v1, assume false "TAG" synch
            } elseif ('LYRICS' == substr($pre_id3v1, 119, 6)) {
