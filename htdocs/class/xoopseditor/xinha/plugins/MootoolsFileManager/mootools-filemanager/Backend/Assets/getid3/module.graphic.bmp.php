...
class getid3_bmp extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if ((1 == $planes22) && (1 != $planes26)) {
            ...
            $info_bmp['type_version'] = 1;
        } elseif (12 == $info_bmp_header_raw['header_size']) {
            $info_bmp['type_os']      = 'OS/2';
            $info_bmp['type_version'] = 1;
        } elseif (40 == $info_bmp_header_raw['header_size']) {
            $info_bmp['type_os']      = 'Windows';
            $info_bmp['type_version'] = 1;
        } elseif (84 == $info_bmp_header_raw['header_size']) {
            $info_bmp['type_os']      = 'Windows';
            $info_bmp['type_version'] = 4;
        } elseif (100 == $info_bmp_header_raw['header_size']) {
            $info_bmp['type_os']      = 'Windows';
        ...
        if ('Windows' == $info_bmp['type_os']) {
            ...
            foreach (['width', 'height', 'resolution_h', 'resolution_v'] as $key) {
            ...
            if (($info_bmp['type_version'] >= 4) || (3 == $info_bmp_header_raw['compression'])) {
