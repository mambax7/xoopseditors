...
class TinyMCE
{
            ...
            for ($i = 1; $i <= 4; ++$i) {
                ...
                if (isset($this->setting['theme_' . $this->setting['theme'] . "_buttons{$i}"])) {
                    ...
                    foreach ($checklist as $plugin) {
                        if (false != mb_strpos(mb_strtolower($plugin), 'xoops')) {
    ...
    public function get_xoopsPlugins()
    {
        ...
        foreach ($allplugins as $plugin) {
            if (false != mb_strpos(mb_strtolower($plugin), 'xoops') && file_exists(XOOPS_ROOT_PATH . $this->config['rootpath'] . "/include/$plugin.php")) {
    ...
    public function render()
    {
        ...
        //   $ret .='language_url : "'.$chemin_path.'/class/xoopseditor/tinymce5bootstrap/tinymce/js/tinymce/langs/fr_FR.js",';

        $ret .= 'external_plugins: {';
        $ret .= '"qrcode": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/qrcode/plugin.min.js",';
        $ret .= '"youtube": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/youtube/plugin.min.js",';
        $ret .= '"alignbtn": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/alignbtn/plugin.min.js",';
        $ret .= '"chartextbtn": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/chartextbtn/plugin.min.js",';
        $ret .= '"xoops_code": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/xoops_code/plugin.min.js",';
        $ret .= '"xoops_quote": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/xoops_quote/plugin.min.js",';
        $ret .= '"xoops_tagextgal": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/xoops_tagextgal/plugin.min.js",';

        $ret .= '"codemirror": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/codemirror/plugin.min.js",';

        $ret .= '"bootstrap": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/bootstrap/plugin.js",';

        $ret .= '"filemanager": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/filemanager/plugin.min.js",';
        $ret .= '"responsivefilemanager": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/responsivefilemanager/plugin.min.js",';
        $ret .= '},';
    ...
    jsFiles: [
       ...
       "mode/php/php.js"
        ...
        $ret .= '"external_filemanager_path": "' . $chemin_path . '/class/xoopseditor/tinymce5bootstrap/external_plugins/filemanager/",';
        $ret .= "\n";
