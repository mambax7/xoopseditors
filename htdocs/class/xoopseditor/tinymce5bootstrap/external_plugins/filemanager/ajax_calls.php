...
if (isset($_GET['action'])) {
    switch ($_GET['action']) {
        ...
        case 'sort':
            ...
            break;
        case 'image_size':
            $pos = mb_strpos($_POST['path'], $upload_dir);
            if (false !== $pos) {
                $info = getimagesize(substr_replace($_POST['path'], $current_path, $pos, mb_strlen($upload_dir)));
        ...
        case 'save_img':
            ...
            if (0 === mb_strpos($_POST['path'], '/')
                ...
                || !in_array(mb_strtolower($info['extension']), ['jpg', 'jpeg', 'png'])) {
                die('wrong data');
            }
