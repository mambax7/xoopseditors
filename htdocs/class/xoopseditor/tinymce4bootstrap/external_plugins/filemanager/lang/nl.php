...
define('lang_Upload_base_help',
       'Klik en sleep (meerdere) bestanden vanaf uw computer naar het "Drop files" vlak hierboven om bestanden toe te voegen.<br/> Ook is het mogelijk om in een dialoogvenster (meerdere) bestanden te selecteren, klik hiervoor op "Drop files"<br/><br/><i>Als alle uploads voltooid zijn kunt u terugkeren met de knop "Terug naar bestanden"</i>'
);
