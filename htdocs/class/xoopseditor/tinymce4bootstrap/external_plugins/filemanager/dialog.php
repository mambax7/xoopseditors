                        ...
                        <div class="filters">
                            <div class="row-fluid">
                                ...
                                <div class="span6 types">
                                    ...
                                    <?php } ?>
                                    <input accesskey="f" type="text" class="filter-input" id="filter-input" name="filter" placeholder="<?php echo fix_strtolower(lang_Text_filter); ?>..." value="<?php echo $filter; ?>"/><?php if ($n_files > $file_number_limit_js) { ?><label id="filter" class="btn"><i
                                                class="icon-play"></i></label><?php } ?>

                                    <input id="select-type-all" name="radio-sort" type="radio" data-item="ff-item-type-all" class="hide"/>
                                    <label id="ff-item-type-all" title="<?php echo lang_All; ?>" <?php if (1 == $_GET['type'] || 3 == $_GET['type']){ ?>style="visibility: hidden;" <?php } ?> data-item="ff-item-type-all" for="select-type-all" style="margin-rigth:0px;"
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="box">
                                        <h4 class="<?php if ($ellipsis_title_after_first_row) {
                                            echo 'ellipsis';
                                        } ?>"><a class="folder-link" data-file="<?php echo $file ?>" href="dialog.php?<?php echo $get_params . urlencode($src) . '&' . uniqid() ?>"><?php echo $file; ?></a></h4>
                                    </div>
