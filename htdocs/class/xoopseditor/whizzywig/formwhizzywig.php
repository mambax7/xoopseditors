 ...
 */
class XoopsFormWhizzywig extends XoopsEditor
{
    ...
    public function __construct($configs)
    {
        ...
        $this->rootPath = '/class/xoopseditor/whizzywig';
    ...
    // PHP 4 Constructor
    public function XoopsFormWhizzywig($configs)
    {
    ...
    public function render()
    {
        ...
        if (!$isJsLoaded) {
            // load css file
            $GLOBALS['xoTheme']->addStylesheet(XOOPS_URL . '/class/xoopseditor/whizzywig/whizzywig/whizzywig.css');
            // load js file
            $GLOBALS['xoTheme']->addScript(XOOPS_URL . '/class/xoopseditor/whizzywig/whizzywig/whizzywig.js');
            // load language file
            $GLOBALS['xoTheme']->addScript(XOOPS_URL . '/class/xoopseditor/whizzywig/whizzywig/' . $this->getLanguage() . '.js');
            $isJsLoaded = true;
        }
        $ret .= "<script type='text/javascript'>addEvt(window,'load',whizzywig);</script>\n";
