...
editor.ui.registry.addButton('qrcode',{icon:true,image:tinyMCE.baseURL+'/plugins/qrcode/icon.png',tooltip:'Create QRcode',shortcut:'Ctrl+QR',onclick:openmanager});editor.addShortcut('Ctrl+QR','',openmanager);editor.ui.registry.addMenuItem('qrcode',{icon:'media',text:'Create QRcode',shortcut:'Ctrl+QR',onclick:openmanager,context:'insert'});});
