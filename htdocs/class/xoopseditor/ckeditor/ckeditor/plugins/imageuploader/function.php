        ...
        for ($i = count($files) - 1; $i >= 0; $i--):
            ...
            if ('block' == $file_style) { ?>
                <div class="fileDiv"
                    ...
                    <p class="fileDescription"><span class="fileMime"><?php echo $image_extension; ?></span> <?php echo $image_filename; ?><?php if ('yes' == $file_extens) {
            ...
            <?php } elseif ('list' == $file_style) { ?>
                <div class="fullWidthFileDiv"
                    ...
                    <p class="fullWidthfileDescription"><?php echo $image_filename; ?><?php if ('yes' == $file_extens) {
                            echo ".$image_extension";
                        } ?></p>
