...
<div id="editbar">
    <div id="editbarView" onclick="#" class="editbarDiv"><img src="img/cd-icon-images.png" class="editbarIcon editbarIconLeft">
        <p class="editbarText"><?php echo $buttons1; ?></p></div>
...
<?php if ($show_settings) { ?>
    <div id="settingsDiv" class="lightbox popout">
        ...
        <?php if ('disabled_pw' != $_SESSION['username']) { ?>
        ...
        <!--report a bug-->
        <p class="uploadP" onclick="window.open('http://ibm.bplaced.com/contact/index.php?cdproject=Image%20Uploader%20and%20Browser%20for%20CKEditor&cdlink=<?php echo $link; ?>&cdver='+currentpluginver,'_blank');"><img src="img/cd-icon-bug.png" class="headerIcon"> <?php echo $panelsettings14; ?>
        </p>
