...
abstract class image
{
    ...
    public final static function factory($driver, $image, array $options = [])
    {
    ...
    public final static function getDriver(array $drivers = ['gd'])
    {
    ...
    final protected function buildImage($image)
    {
        ...
        return (false !== $img) ? [$img, $width, $height] : false;
    }
